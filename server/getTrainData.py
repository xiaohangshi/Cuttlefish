...
def write_info(s5, s4, s3, s2, s1, filelist):
...
def prepare(videopath, file_list, timeslot=1.0):
    ...
    while success:
        ...
        if index == slot_frame:
            ...
            write_info(frames360p, frames480p, frames720p, frames900p, frames1080p, file_list)
...
if __name__ == '__main__':
    ...
    slots360p, slots480p, slots720p, slots900p, slots1080p = prepare(opt.input, filelist, 1.0)
    print("finished!")
